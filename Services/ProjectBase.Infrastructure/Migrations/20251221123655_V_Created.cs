...
{
    /// <inheritdoc />
    public partial class V_Created : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "DeletedBy", "DeletedDate", "Name" },
                values: new object[,]
                {
                    { 1, null, null, "SystemAdmin" },
                    { 2, null, null, "TenantAdmin" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, "SystemUser" },
                    { 2, null, null, "TenantUser" }
                });
